...
public class Employee extends EmployeeKey {
    ...
    public void setBday(String bday) {
        this.bday = bday == null ? null : bday.trim();
    }
    ...
    public String getWex() {
        return wex;
    }

    public void setWex(String wex) {
        this.wex = wex == null ? null : wex.trim();
    }
    ...
    public void setJday(String jday) {
        this.jday = jday == null ? null : jday.trim();
    }
    ...
    public void setCoperson(String coperson) {
        this.coperson = coperson == null ? null : coperson.trim();
    }
